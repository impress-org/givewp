...
<?php } else { ?>
	<?php give_output_error( apply_filters('give_already_logged_in_message', sprintf( '%1$s <a href="%2$s">%3$s</a>', esc_html__( 'You are already logged in to the site.', 'give' ), esc_url( $give_logout_redirect ), esc_html__( 'Logout.', 'give' ) ) ), true, 'warning' ); ?>
<?php } ?>