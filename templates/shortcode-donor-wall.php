    ...
    <div class="give-donor">
        ...
        <?php if (isset( $donation['_give_tributes_first_name'] ) || isset( $donation['_give_tributes_Last_name']) ) : ?>
            <div class="give-donor-tribute">
                ...
                <p class="give-donor-tribute__message"> <span> This was given in honor of </span>
                    <span>
                        <?php
                        $honorFirstName = $donation['_give_tributes_first_name'];
                        $honorLastName = $donation['_give_tributes_last_name'];
                        $honorFullName = trim($honorFirstName . " " . $honorLastName[0] . "." );

                        echo esc_html( $honorFullName ) ?>
                    </span>
                </p>
            </div>
        <?php endif; ?>
