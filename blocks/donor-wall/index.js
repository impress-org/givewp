...
export default registerBlockType('give/donor-wall', {
    ...
    description: __(
        'The GiveWP Donor Wall block displays donations on the front end of the site. The settings below allow you to customize the information displayed',
        'give'
    ),
    category: 'give',
    icon: <GiveIcon color="grey" />,
    keywords: [__('donation', 'give'), __('wall', 'give')],
    supports: {
        html: false,
    },
