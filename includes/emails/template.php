...
function give_email_preview_template_tags( $message ) {
	...
	$price = give_currency_filter( give_format_amount( 10.50, true, false ) );
...
function give_get_donation_notification_body_content( $payment_id = 0, $payment_data = array() ) {
	...
	$default_email_body .= esc_html__( 'Amount:', 'give' ) . ' ' . html_entity_decode( give_currency_filter( give_format_amount( give_get_payment_amount( $payment_id ), true, false ) ), ENT_COMPAT, 'UTF-8' ) . "\n";
