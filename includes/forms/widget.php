...
class Give_Forms_Widget extends WP_Widget{
	...
	public function form( $instance ){
		...
		<p>
			...
			&nbsp;&nbsp;<label for="<?php echo $this->get_field_id( 'display_style' ); ?>-button_only"><input type="radio" class="widefat" id="<?php echo $this->get_field_id( 'display_style' ); ?>-button_only" name="<?php echo $this->get_field_name( 'display_style' ); ?>" value="button_only" <?php checked( $instance['display_style'], 'button_only' ); ?>> <?php echo esc_html__( 'Button Only', 'give' ); ?></label><br>
