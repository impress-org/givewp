...
function give_get_donation_form( $args = array() ) {
	...
	// @todo: rethink about theme loading logic.
	$form_style = give_get_templates_dir() . '/form-styles/legecy/index.php';
	if ( give_is_viewing_embed_form() ) {
		$form_style = give_get_templates_dir() . '/form-styles/elegent/index.php';
	}
