	...
	if ( $form_option === 'yes' && ! empty( $terms ) ) { ?>
		<fieldset id="give_terms_agreement">
			...
			<div id="give_show_terms">
				<a href="#" class="give_terms_links give_terms-<?php echo $form_id;?>"><?php _e( 'Show Terms', 'give' ); ?></a>
				<a href="#" class="give_terms_links give_terms-<?php echo $form_id;?>" style="display:none;"><?php _e( 'Hide Terms', 'give' ); ?></a>
			</div>
