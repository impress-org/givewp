 ...
 * Get Country List
 *
 * @param string $default Value to set for default selection.
 *
 * @since  1.0
...
function give_get_country_list( $default = '' ) {
	$countries = array(
		...
		'US' => __( 'United States', 'give' ),
		'CA' => __( 'Canada', 'give' ),
		'GB' => __( 'United Kingdom', 'give' ),
		'AF' => __( 'Afghanistan', 'give' ),
		'AL' => __( 'Albania', 'give' ),
		'DZ' => __( 'Algeria', 'give' ),
		'AS' => __( 'American Samoa', 'give' ),
		'AD' => __( 'Andorra', 'give' ),
		'AO' => __( 'Angola', 'give' ),
		'AI' => __( 'Anguilla', 'give' ),
		'AQ' => __( 'Antarctica', 'give' ),
		'AG' => __( 'Antigua and Barbuda', 'give' ),
		'AR' => __( 'Argentina', 'give' ),
		'AM' => __( 'Armenia', 'give' ),
		'AW' => __( 'Aruba', 'give' ),
		'AU' => __( 'Australia', 'give' ),
		'AT' => __( 'Austria', 'give' ),
		'AZ' => __( 'Azerbaijan', 'give' ),
		'BS' => __( 'Bahamas', 'give' ),
		'BH' => __( 'Bahrain', 'give' ),
		'BD' => __( 'Bangladesh', 'give' ),
		'BB' => __( 'Barbados', 'give' ),
		'BY' => __( 'Belarus', 'give' ),
		'BE' => __( 'Belgium', 'give' ),
		'BZ' => __( 'Belize', 'give' ),
		...
		'BT' => __( 'Bhutan', 'give' ),
		'BO' => __( 'Bolivia', 'give' ),
		'BA' => __( 'Bosnia and Herzegovina', 'give' ),
		'BW' => __( 'Botswana', 'give' ),
		'BV' => __( 'Bouvet Island', 'give' ),
		'BR' => __( 'Brazil', 'give' ),
		'IO' => __( 'British Indian Ocean Territory', 'give' ),
		'BN' => __( 'Brunei Darrussalam', 'give' ),
		'BG' => __( 'Bulgaria', 'give' ),
		'BF' => __( 'Burkina Faso', 'give' ),
		'BI' => __( 'Burundi', 'give' ),
		'KH' => __( 'Cambodia', 'give' ),
		'CM' => __( 'Cameroon', 'give' ),
		'CV' => __( 'Cape Verde', 'give' ),
		'KY' => __( 'Cayman Islands', 'give' ),
		'CF' => __( 'Central African Republic', 'give' ),
		'TD' => __( 'Chad', 'give' ),
		'CL' => __( 'Chile', 'give' ),
		'CN' => __( 'China', 'give' ),
		'CX' => __( 'Christmas Island', 'give' ),
		'CC' => __( 'Cocos Islands', 'give' ),
		'CO' => __( 'Colombia', 'give' ),
		'KM' => __( 'Comoros', 'give' ),
		'CD' => __( 'Congo, Democratic People\'s Republic', 'give' ),
		'CG' => __( 'Congo, Republic of', 'give' ),
		'CK' => __( 'Cook Islands', 'give' ),
		'CR' => __( 'Costa Rica', 'give' ),
		'CI' => __( 'Cote d\'Ivoire', 'give' ),
		'HR' => __( 'Croatia/Hrvatska', 'give' ),
		'CU' => __( 'Cuba', 'give' ),
		'CY' => __( 'Cyprus Island', 'give' ),
		'CZ' => __( 'Czech Republic', 'give' ),
		'DK' => __( 'Denmark', 'give' ),
		'DJ' => __( 'Djibouti', 'give' ),
		'DM' => __( 'Dominica', 'give' ),
		'DO' => __( 'Dominican Republic', 'give' ),
		'TP' => __( 'East Timor', 'give' ),
		'EC' => __( 'Ecuador', 'give' ),
		'EG' => __( 'Egypt', 'give' ),
		'GQ' => __( 'Equatorial Guinea', 'give' ),
		'SV' => __( 'El Salvador', 'give' ),
		'ER' => __( 'Eritrea', 'give' ),
		'EE' => __( 'Estonia', 'give' ),
		'ET' => __( 'Ethiopia', 'give' ),
		'FK' => __( 'Falkland Islands', 'give' ),
		'FO' => __( 'Faroe Islands', 'give' ),
		'FJ' => __( 'Fiji', 'give' ),
		'FI' => __( 'Finland', 'give' ),
		'FR' => __( 'France', 'give' ),
		'GF' => __( 'French Guiana', 'give' ),
		'PF' => __( 'French Polynesia', 'give' ),
		'TF' => __( 'French Southern Territories', 'give' ),
		'GA' => __( 'Gabon', 'give' ),
		'GM' => __( 'Gambia', 'give' ),
		'GE' => __( 'Georgia', 'give' ),
		'DE' => __( 'Germany', 'give' ),
		'GR' => __( 'Greece', 'give' ),
		'GH' => __( 'Ghana', 'give' ),
		'GI' => __( 'Gibraltar', 'give' ),
		'GL' => __( 'Greenland', 'give' ),
		'GD' => __( 'Grenada', 'give' ),
		'GP' => __( 'Guadeloupe', 'give' ),
		'GU' => __( 'Guam', 'give' ),
		'GT' => __( 'Guatemala', 'give' ),
		'GG' => __( 'Guernsey', 'give' ),
		'GN' => __( 'Guinea', 'give' ),
		'GW' => __( 'Guinea-Bissau', 'give' ),
		'GY' => __( 'Guyana', 'give' ),
		'HT' => __( 'Haiti', 'give' ),
		'HM' => __( 'Heard and McDonald Islands', 'give' ),
		'VA' => __( 'Holy See (City Vatican State)', 'give' ),
		'HN' => __( 'Honduras', 'give' ),
		'HK' => __( 'Hong Kong', 'give' ),
		'HU' => __( 'Hungary', 'give' ),
		'IS' => __( 'Iceland', 'give' ),
		'IN' => __( 'India', 'give' ),
		'ID' => __( 'Indonesia', 'give' ),
		'IR' => __( 'Iran', 'give' ),
		'IQ' => __( 'Iraq', 'give' ),
		'IE' => __( 'Ireland', 'give' ),
		'IM' => __( 'Isle of Man', 'give' ),
		'IL' => __( 'Israel', 'give' ),
		'IT' => __( 'Italy', 'give' ),
		'JM' => __( 'Jamaica', 'give' ),
		'JP' => __( 'Japan', 'give' ),
		'JE' => __( 'Jersey', 'give' ),
		'JO' => __( 'Jordan', 'give' ),
		'KZ' => __( 'Kazakhstan', 'give' ),
		'KE' => __( 'Kenya', 'give' ),
		'KI' => __( 'Kiribati', 'give' ),
		'KW' => __( 'Kuwait', 'give' ),
		'KG' => __( 'Kyrgyzstan', 'give' ),
		'LA' => __( 'Lao People\'s Democratic Republic', 'give' ),
		'LV' => __( 'Latvia', 'give' ),
		'LB' => __( 'Lebanon', 'give' ),
		'LS' => __( 'Lesotho', 'give' ),
		'LR' => __( 'Liberia', 'give' ),
		'LY' => __( 'Libyan Arab Jamahiriya', 'give' ),
		'LI' => __( 'Liechtenstein', 'give' ),
		'LT' => __( 'Lithuania', 'give' ),
		'LU' => __( 'Luxembourg', 'give' ),
		'MO' => __( 'Macau', 'give' ),
		'MK' => __( 'Macedonia', 'give' ),
		'MG' => __( 'Madagascar', 'give' ),
		'MW' => __( 'Malawi', 'give' ),
		'MY' => __( 'Malaysia', 'give' ),
		'MV' => __( 'Maldives', 'give' ),
		'ML' => __( 'Mali', 'give' ),
		'MT' => __( 'Malta', 'give' ),
		'MH' => __( 'Marshall Islands', 'give' ),
		'MQ' => __( 'Martinique', 'give' ),
		'MR' => __( 'Mauritania', 'give' ),
		'MU' => __( 'Mauritius', 'give' ),
		'YT' => __( 'Mayotte', 'give' ),
		'MX' => __( 'Mexico', 'give' ),
		'FM' => __( 'Micronesia', 'give' ),
		'MD' => __( 'Moldova, Republic of', 'give' ),
		'MC' => __( 'Monaco', 'give' ),
		'MN' => __( 'Mongolia', 'give' ),
		'ME' => __( 'Montenegro', 'give' ),
		'MS' => __( 'Montserrat', 'give' ),
		'MA' => __( 'Morocco', 'give' ),
		'MZ' => __( 'Mozambique', 'give' ),
		'MM' => __( 'Myanmar', 'give' ),
		'NA' => __( 'Namibia', 'give' ),
		'NR' => __( 'Nauru', 'give' ),
		'NP' => __( 'Nepal', 'give' ),
		'NL' => __( 'Netherlands', 'give' ),
		'AN' => __( 'Netherlands Antilles', 'give' ),
		'NC' => __( 'New Caledonia', 'give' ),
		'NZ' => __( 'New Zealand', 'give' ),
		'NI' => __( 'Nicaragua', 'give' ),
		'NE' => __( 'Niger', 'give' ),
		'NG' => __( 'Nigeria', 'give' ),
		'NU' => __( 'Niue', 'give' ),
		'NF' => __( 'Norfolk Island', 'give' ),
		'KP' => __( 'North Korea', 'give' ),
		'MP' => __( 'Northern Mariana Islands', 'give' ),
		'NO' => __( 'Norway', 'give' ),
		'OM' => __( 'Oman', 'give' ),
		'PK' => __( 'Pakistan', 'give' ),
		'PW' => __( 'Palau', 'give' ),
		'PS' => __( 'Palestinian Territories', 'give' ),
		'PA' => __( 'Panama', 'give' ),
		'PG' => __( 'Papua New Guinea', 'give' ),
		'PY' => __( 'Paraguay', 'give' ),
		'PE' => __( 'Peru', 'give' ),
		'PH' => __( 'Phillipines', 'give' ),
		'PN' => __( 'Pitcairn Island', 'give' ),
		'PL' => __( 'Poland', 'give' ),
		'PT' => __( 'Portugal', 'give' ),
		'PR' => __( 'Puerto Rico', 'give' ),
		'QA' => __( 'Qatar', 'give' ),
		'RE' => __( 'Reunion Island', 'give' ),
		'RO' => __( 'Romania', 'give' ),
		'RU' => __( 'Russian Federation', 'give' ),
		'RW' => __( 'Rwanda', 'give' ),
		'SH' => __( 'Saint Helena', 'give' ),
		'KN' => __( 'Saint Kitts and Nevis', 'give' ),
		'LC' => __( 'Saint Lucia', 'give' ),
		'PM' => __( 'Saint Pierre and Miquelon', 'give' ),
		'VC' => __( 'Saint Vincent and the Grenadines', 'give' ),
		'SM' => __( 'San Marino', 'give' ),
		'ST' => __( 'Sao Tome and Principe', 'give' ),
		'SA' => __( 'Saudi Arabia', 'give' ),
		'SN' => __( 'Senegal', 'give' ),
		'RS' => __( 'Serbia', 'give' ),
		'SC' => __( 'Seychelles', 'give' ),
		'SL' => __( 'Sierra Leone', 'give' ),
		'SG' => __( 'Singapore', 'give' ),
		'SK' => __( 'Slovak Republic', 'give' ),
		'SI' => __( 'Slovenia', 'give' ),
		'SB' => __( 'Solomon Islands', 'give' ),
		'SO' => __( 'Somalia', 'give' ),
		'ZA' => __( 'South Africa', 'give' ),
		'GS' => __( 'South Georgia', 'give' ),
		'KR' => __( 'South Korea', 'give' ),
		'ES' => __( 'Spain', 'give' ),
		'LK' => __( 'Sri Lanka', 'give' ),
		'SD' => __( 'Sudan', 'give' ),
		'SR' => __( 'Suriname', 'give' ),
		'SJ' => __( 'Svalbard and Jan Mayen Islands', 'give' ),
		'SZ' => __( 'Swaziland', 'give' ),
		'SE' => __( 'Sweden', 'give' ),
		'CH' => __( 'Switzerland', 'give' ),
		'SY' => __( 'Syrian Arab Republic', 'give' ),
		'TW' => __( 'Taiwan', 'give' ),
		'TJ' => __( 'Tajikistan', 'give' ),
		'TZ' => __( 'Tanzania', 'give' ),
		'TG' => __( 'Togo', 'give' ),
		'TK' => __( 'Tokelau', 'give' ),
		'TO' => __( 'Tonga', 'give' ),
		'TH' => __( 'Thailand', 'give' ),
		'TT' => __( 'Trinidad and Tobago', 'give' ),
		'TN' => __( 'Tunisia', 'give' ),
		'TR' => __( 'Turkey', 'give' ),
		'TM' => __( 'Turkmenistan', 'give' ),
		'TC' => __( 'Turks and Caicos Islands', 'give' ),
		'TV' => __( 'Tuvalu', 'give' ),
		'UG' => __( 'Uganda', 'give' ),
		'UA' => __( 'Ukraine', 'give' ),
		'AE' => __( 'United Arab Emirates', 'give' ),
		'UY' => __( 'Uruguay', 'give' ),
		'UM' => __( 'US Minor Outlying Islands', 'give' ),
		'UZ' => __( 'Uzbekistan', 'give' ),
		'VU' => __( 'Vanuatu', 'give' ),
		'VE' => __( 'Venezuela', 'give' ),
		'VN' => __( 'Vietnam', 'give' ),
		'VG' => __( 'Virgin Islands (British)', 'give' ),
		'VI' => __( 'Virgin Islands (USA)', 'give' ),
		'WF' => __( 'Wallis and Futuna Islands', 'give' ),
		'EH' => __( 'Western Sahara', 'give' ),
		'WS' => __( 'Western Samoa', 'give' ),
		'YE' => __( 'Yemen', 'give' ),
		'YU' => __( 'Yugoslavia', 'give' ),
		'ZM' => __( 'Zambia', 'give' ),
		'ZW' => __( 'Zimbabwe', 'give' ),
	);
