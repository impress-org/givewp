...
function give_get_purchase_stats_by_user( $user = '' ) {
	 ...
	 *
	 * @deprecated 1.9 Use {@see 'give_donation_stats_by_user'} instead.
	 */
	$stats = (array) apply_filters_deprecated( 'give_purchase_stats_by_user', array( $stats, $user ), '1.9', 'give_donation_stats_by_user' );
