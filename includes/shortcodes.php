...
use function Give\Helper\Session\DonationConfirmation\storePostedData as storeDataPostedOnDonationConfirmationPage;
...
function give_form_shortcode( $atts ) {
	...
	if ( $activeTheme && 'legacy' !== $activeTheme ) {
		...
		storeDataPostedOnDonationConfirmationPage();
