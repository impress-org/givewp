...
function give_form_grid_shortcode( $atts ) {
	...
	if ( $form_query->have_posts() ) {
		...
		remove_filter( 'add_give_goal_progress_class', 'add_give_goal_progress_class', 10 );
		remove_filter( 'add_give_goal_progress_bar_class', 'add_give_goal_progress_bar_class', 10 );
