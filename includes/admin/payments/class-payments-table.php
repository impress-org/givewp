 ...
 * @copyright   Copyright (c) 2014, Give
	...
	public function column_default( $payment, $column_name ) {
		switch ( $column_name ) {
			...
			case 'status' :
				...
				$value   = give_get_payment_status( $payment, true );
				break;
			case 'details' :
