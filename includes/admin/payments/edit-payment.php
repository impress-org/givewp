...
?>
<div class="wrap">
	<h2><?php _e( 'Edit Payment', 'edd' ); ?>: <?php echo get_the_title( $payment_id ) . ' - #' . $payment_id; ?> -
		<a href="<?php echo admin_url( 'edit.php?post_type=download&page=edd-payment-history' ); ?>" class="button-secondary"><?php _e( 'Go Back', 'edd' ); ?></a>
	</h2>
	...
	<form id="edd-edit-payment" action="" method="post">
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<input class="regular-text" type="text" name="edd-buyer-email" id="edd-buyer-email" value="<?php echo give_get_payment_user_email( $payment_id ); ?>" />
			...
			<tr>
				...
				<td>
					<input class="small-text" type="number" min="-1" step="1" name="edd-buyer-user-id" id="edd-buyer-user-id" value="<?php echo give_get_payment_user_id( $payment_id ); ?>" />
			...
			<tr>
				<th scope="row" valign="top">
					<span><?php printf( __( 'Payment Amount in %s', 'edd' ), give_get_currency() ); ?></span>
				</th>
				<td>
			...
			<tr>
				...
				<td id="purchased-downloads">
					...
					?>
					<p id="edit-downloads">
						<a href="#TB_inline?width=640&amp;inlineId=available-downloads" class="thickbox" title="<?php printf( __( 'Add %s to purchase', 'edd' ), strtolower( give_get_label_plural() ) ); ?>"><?php printf( __( 'Add %s to purchase', 'edd' ), strtolower( give_get_label_plural() ) ); ?></a>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<label class="description" for="give_unlimited_downloads"><?php _e( 'Check this box to enable unlimited file downloads for this purchase.', 'edd' ); ?></label>
				</td>
			</tr>
			<tr id="give_payment_notification" style="display:none;">
				...
				<td>
					...
					<label class="description" for="give_send_email"><?php _e( 'Check this box to send the purchase receipt, including all download links.', 'edd' ); ?></label>
				</td>
			</tr>
	...
	<div id="available-downloads" style="display:none;">
		<form id="edd-add-downloads-to-purchase">
			...
			<p>
				<a href="#" class="button-secondary edd-add-another-download"><?php echo sprintf( __( 'Add Another %s', 'edd' ), esc_html( give_get_label_singular() ) ); ?></a>
			</p>
