...
function give_reporting_contextual_help() {
	...
	$screen->add_help_tab( array(
		...
		'content' =>
			...
			'<p>' . __( "<strong>Donors</strong> - This report exports all of your donors in a CSV format. It exports the customer's name and email address and the amount of products they have purchased as well as the final price of their total purchases.", 'give' ) . '</p>' .
