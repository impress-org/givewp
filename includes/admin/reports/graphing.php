		...
		<div class="metabox-holder" style="padding-top: 0;">
			...
			<table class="widefat reports-table alignleft" style="max-width:450px">
				...
				<tr>
					...
					<td><?php echo give_currency_filter( give_format_amount( $earnings_totals, true, false ) ); ?></td>
				</tr>
				<tr class="alternate">
				...
				<?php if ( 'this_month' == $dates['range'] ) : ?>
					<tr>
						...
						<td><?php echo give_currency_filter( give_format_amount( $estimated['earnings'], true, false ) ); ?></td>
					</tr>
					<tr class="alternate">
		...
		<div class="metabox-holder" style="padding-top: 0;">
			...
			<table class="widefat reports-table alignleft" style="max-width:450px">
				...
				<tr>
					...
					<td><?php echo give_currency_filter( give_format_amount( give_get_average_monthly_form_earnings( $form_id ), true, false ) ); ?></td>
				</tr>
				<tr class="alternate">
