...
if ( ! class_exists( 'Give_Export_Donations' ) ) {
	...
	final class Give_Export_Donations {
		...
		public function html() {
			...
			<section>
				<table class="widefat export-options-table give-table">
					...
					<tr valign="top">
						<th colspan="2">
							<h2 id="give-import-title"><?php esc_html_e( 'Export Donation History and Custom Fields to CSV', 'give' ) ?></h2>
					...
					if ( give_is_setting_enabled( give_get_option( 'categories' ) ) ) {
						...
						<tr valign="top">
							<th scope="row" class="titledesc">
								<label for="json"><?php _e( 'Filter by Form Categories:', 'give' ); ?></label>
							</th>
							<td class="give-forminp">
								<div class="give-field-wrap">
									<label for="json">
					...
					if ( give_is_setting_enabled( give_get_option( 'tags' ) ) ) {
						...
						<tr valign="top">
							<th scope="row" class="titledesc">
								<label for="json"><?php _e( 'Filter by Form Tags:', 'give' ); ?></label>
							</th>
							<td class="give-forminp">
								<div class="give-field-wrap">
									<label for="json">
		...
		public function render_page() {
			include_once GIVE_PLUGIN_DIR . 'includes/admin/tools/views/html-admin-page-export-donations.php';
		}
