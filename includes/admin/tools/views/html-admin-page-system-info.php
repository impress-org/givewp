...
<table class="give-status-table widefat" cellspacing="0" id="status">
	...
	<tbody>
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The URL of your site\'s homepage.', 'give' ) ); ?>"><i class="give-icon give-icon-question" ></i></span></td>
			<td><?php form_option( 'home' ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Site URL"><?php _e( 'Site URL', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The root URL of your site.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php form_option( 'siteurl' ); ?></td>
		</tr>
		<tr>
			<td data-export-label="WP Version"><?php _e( 'WP Version', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The version of WordPress installed on your site.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php bloginfo('version'); ?></td>
		</tr>
		<tr>
			<td data-export-label="WP Multisite"><?php _e( 'WP Multisite', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether or not you have WordPress Multisite enabled.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The maximum amount of memory (RAM) that your site can use at one time.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Displays whether or not WordPress is in Debug Mode.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Displays whether or not WP Cron Jobs are enabled.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The current language used by WordPress. Default = English', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo get_locale(); ?></td>
		</tr>
		<tr>
			<td data-export-label="Permalink Structure"><?php _e( 'Permalink Structure', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The permalink structure as defined in Settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether your front page is set to show posts or a static page.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<?php if ( 'page' === get_option( 'show_on_front' ) ) : ?>
			...
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The page set to display as your front page.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			...
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The page set to display your posts.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The length of the table prefix used in your WordPress database.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo esc_html( strlen( $wpdb->prefix ) ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Table Prefix Status"><?php _e( 'Table Prefix Status', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The status of the table prefix used in your WordPress database.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether Admin AJAX is accessible.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'A list of all registered post stati.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
...
<table class="give-status-table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The hosting provider for this WordPress installation.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Information about the web server that is currently hosting your site.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo esc_html( $_SERVER['SERVER_SOFTWARE'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="PHP Version"><?php _e( 'PHP Version', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The version of PHP installed on your hosting server.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php
		...
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The largest filesize that can be contained in one post.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			...
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The amount of time (in seconds) that your site will spend on a single operation before timing out (to avoid server lockups).', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td><?php echo ini_get( 'max_execution_time' ); ?></td>
			</tr>
			<tr>
				<td data-export-label="PHP Max Input Vars"><?php _e( 'PHP Max Input Vars', 'give' ); ?>:</td>
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The maximum number of variables your server can use for a single function to avoid overloads.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td><?php echo ini_get( 'max_input_vars' ); ?></td>
			</tr>
			<tr>
				<td data-export-label="PHP Max Upload Size"><?php _e( 'PHP Max Upload Size', 'give' ); ?>:</td>
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The largest filesize that can be uploaded to your WordPress installation.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td><?php echo size_format( wp_max_upload_size() ); ?></td>
			</tr>
			<tr>
				<td data-export-label="cURL Version"><?php _e( 'cURL Version', 'give' ); ?>:</td>
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The version of cURL installed on your server.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td>
					<?php
			...
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Suhosin is an advanced protection system for PHP installations. It was designed to protect your servers on the one hand against a number of well known problems in PHP applications and on the other hand against potential unknown vulnerabilities within these applications or the PHP core itself. If enabled on your server, Suhosin may need to be configured to increase its data submission limits.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		if ( ! empty( $wpdb->is_mysql ) && ! stristr( $ver, 'MariaDB' ) ) : ?>
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The version of MySQL installed on your hosting server.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td>
					<?php
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The default timezone for your server.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php
		...
		foreach ( $posting as $post ) {
			...
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( isset( $post['help'] ) ? $post['help'] : '' ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td>
...
<table class="give-status-table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The version of Give installed on your site.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo esc_html( GIVE_VERSION ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Upgraded From"><?php _e( 'Upgraded From', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The version of Give installed prior to the last update.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether Test Mode is enabled in Give settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The currency code selected in Give settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo esc_html( give_get_currency() ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Currency Position"><?php _e( 'Currency Position', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The currency position selected in Give settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The decimal separator defined in Give settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The thousands separator defined in Give settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo esc_html( give_get_option( 'thousands_separator', ',' ) ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Success Page"><?php _e( 'Success Page', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The page where donors land following a successful transaction.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The page where donors land following a failed transaction.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The slug used for Give donation forms.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'All payment gateways enabled in Give settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The default payment gateway selected in Give settings.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether admins receive email notifications of transactions.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether donors can access their donation history using only email.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
...
<table class="give-status-table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether PHP sessions are enforced, enabled, or disabled.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether a PHP session is currently set.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
		...
		<?php if ( isset( $_SESSION ) ) { ?>
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The name of the current PHP session.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td><?php echo esc_html( ini_get( 'session.name' ) ); ?></td>
			</tr>
			<tr>
				<td data-export-label="Cookie Path"><?php _e( 'Cookie Path', 'give' ); ?>:</td>
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The cookie path of the current PHP session.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td><?php echo esc_html( ini_get( 'session.cookie_path' ) ); ?></td>
			</tr>
			<tr>
				<td data-export-label="Save Path"><?php _e( 'Save Path', 'give' ); ?>:</td>
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The save path of the current PHP session.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td><?php echo esc_html( ini_get( 'session.save_path' ) ); ?></td>
			</tr>
			<tr>
				<td data-export-label="Use Cookies"><?php _e( 'Use Cookies', 'give' ); ?>:</td>
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether the current PHP session is set to use cookies.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			...
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether the current PHP session is set to use only cookies.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
...
<table class="give-status-table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The name of the current active theme.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo esc_html( $active_theme->Name ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Version"><?php _e( 'Version', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The installed version of the current active theme.', 'give' ) ); ?>"></span></td>
			<td><?php echo esc_html( $active_theme->Version ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Author URL"><?php _e( 'Author URL', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The theme developer\'s URL.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php echo $active_theme->{'Author URI'}; ?></td>
		</tr>
		<tr>
			<td data-export-label="Child Theme"><?php _e( 'Child Theme', 'give' ); ?>:</td>
			<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'Whether the current theme is a child theme.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			<td><?php
		...
		?>
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The name of the parent theme.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
				<td><?php echo esc_html( $parent_theme->Name ); ?></td>
			</tr>
			<tr>
				<td data-export-label="Parent Theme Version"><?php _e( 'Parent Theme Version', 'give' ); ?>:</td>
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The installed version of the parent theme.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
			...
			<tr>
				...
				<td class="help"><span class="give-tooltip hint--top" aria-label="<?php echo esc_attr( __( 'The parent theme developers URL.', 'give' ) ); ?>"><i class="give-icon give-icon-question"></i></span></td>
