 ...
 * @param array $field
 */
function give_wp_text_input( $field ) {
 ...
 * @param array $field
 */
function give_wp_hidden_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function give_wp_textarea_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function give_wp_wysiwyg( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function give_wp_checkbox( $field ) {
	global $thepostid, $post;
...
function give_wp_select( $field ) {
	...
	echo '<p class="form-field ' . esc_attr( $field['id'] ) . '_field ' . esc_attr( $field['wrapper_class'] ) . '"><label for="' . esc_attr( $field['id'] ) . '">' . wp_kses_post( $field['name'] ) . '</label><select id="' . esc_attr( $field['id'] ) . '" name="' . esc_attr( $field['name'] ) . '" class="' . esc_attr( $field['class'] ) . '" style="' . esc_attr( $field['style'] ) . '" ' . implode( ' ', $custom_attributes ) . '>';
 ...
 * @param array $field
 */
function give_wp_colorpicker( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function give_wp_default_gateway( $field ) {
	global $thepostid, $post;
