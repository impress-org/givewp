...
function give_payment_amount( $payment_id = 0 ) {
	...
	return give_currency_filter( give_format_amount( $amount, true, false ), give_get_payment_currency_code( $payment_id ) );
}
...
function give_payment_subtotal( $payment_id = 0 ) {
	...
	return give_currency_filter( give_format_amount( $subtotal , true, false ), give_get_payment_currency_code( $payment_id ) );
}
...
function give_get_form_variable_price_dropdown( $args = array(), $echo = false ) {
	...
	foreach ( $variable_prices as $variable_price ) {
		$variable_price_options[ $variable_price['_give_id']['level_id'] ] = ! empty( $variable_price['_give_text'] ) ? $variable_price['_give_text'] : give_currency_filter( give_format_amount( $variable_price['_give_amount'], true, false ) );
	}
