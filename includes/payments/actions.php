...
add_action( 'give_complete_donation', '__give_update_goal_closed_meta_on_donation_update', 10, 1 );
add_action( 'give_payment_delete', '__give_update_goal_closed_meta_on_donation_update', 10, 1 );
