		...
		switch ( $process ) {
			case 'generate':
				if ( $this->generate_api_key( $user_id ) ) {
					...
					wp_redirect( add_query_arg( 'give-message', 'api-key-generated', 'edit.php?post_type=give_forms&page=give-settings&tab=tools' ) );
					exit();
				} else {
					wp_redirect( add_query_arg( 'give-message', 'api-key-failed', 'edit.php?post_type=give_forms&page=give-settings&tab=tools' ) );
					exit();
				}
				break;
			case 'regenerate':
				...
				delete_transient( 'give_total_api_keys' );
				wp_redirect( add_query_arg( 'give-message', 'api-key-regenerated', 'edit.php?post_type=give_forms&page=give-settings&tab=tools' ) );
				exit();
				break;
			case 'revoke':
				$this->revoke_api_key( $user_id );
				delete_transient( 'give_total_api_keys' );
				wp_redirect( add_query_arg( 'give-message', 'api-key-revoked', 'edit.php?post_type=give_forms&page=give-settings&tab=tools' ) );
				exit();
				break;
			default;
				break;
