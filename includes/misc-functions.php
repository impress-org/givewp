 ...
 * @param  string|bool $replacement Optional. The hook that should have been used. Default false.
 * @param  string      $message     Optional. A message regarding the change. Default null.
 *
 * @return mixed
 */
function _give_apply_filters_deprecated( $tag, $args, $version, $replacement = false, $message = null ) {
	if ( ! has_filter( $tag ) ) {
		return $args[0];
	}

	_give_deprecated_hook( $tag, $version, $replacement, $message );
 ...
 * @param  string      $version     The version of WordPress that deprecated the hook.
 * @param  string|bool $replacement Optional. The hook that should have been used.
 * @param  string      $message     Optional. A message regarding the change.
 *
 * @return mixed
 */
function _give_do_action_deprecated( $tag, $args, $version, $replacement = false, $message = null ) {
	if ( ! has_action( $tag ) ) {
		return;
	}
 ...
 *
 * Use the {@see 'give_deprecated_hook_run'} action to get the backtrace describing where
 * the deprecated hook was called.
 *
 * Default behavior is to trigger a user error if `WP_DEBUG` is true.
 *
 * This function is called by the _give_do_action_deprecated() and _give_apply_filters_deprecated()
 ...
 * @param string $message     Optional. A message regarding the change.
 */
function _give_deprecated_hook( $hook, $version, $replacement = null, $message = null ) {
	/**
	 ...
	 */
	do_action( 'give_deprecated_hook_run', $hook, $replacement, $version, $message );
	 ...
	 */
	if ( WP_DEBUG && apply_filters( 'give_deprecated_hook_trigger_error', true ) ) {
