...
function give_offline_send_admin_notice( $payment_id = 0 ) {
	...
	$admin_message .= __( 'A new offline donation has been made on your website:', 'give' ) . ' ' . get_bloginfo( 'name' ) . "\n\n";
	$admin_message .= sprintf(__( 'Hooray! The %s donation is in a pending status and is awaiting payment. Donation instructions have been emailed to the donor. Once you receive payment, be sure to mark the donation as complete using the link below.', 'give' ), $amount) . "\n\n";
