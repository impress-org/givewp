...
/**
 * This function will be used to get localize variables to be passed into any of the scripts.
 *
 * @since 2.5.5
 *
 * @return array
 */
function give_stripe_get_localize_vars() {
	...
	return apply_filters( 'give_stripe_get_localize_vars', array(
