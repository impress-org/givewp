...
jQuery( document ).ready( function( $ ) {
	...
	if( Give.form.fn.isFormExist() ) {
		...
		const resetNonce = '1' === Give.fn.__getCookie( Give.fn.getGlobalVar( 'nonce_cookie_name' ) ) && '1' !== Give.fn.getGlobalVar( 'delete_session_nonce_cookie' );
	...
	if (recieptContainer) {
		...
		const cookie_name = Give.fn.getGlobalVar( 'nonce_cookie_name' );
