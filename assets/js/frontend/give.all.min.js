...
<<<<<<< HEAD
function give_load_gateway(e,i){var a=jQuery(e).find("#give-payment-mode-select .give-loading-animation"),t=jQuery(e).find("#give-amount").val(),o=jQuery(e).find('input[name="give-form-id"]').val();a.parent().fadeIn();var n=jQuery(e).data();1!=n["blockUI.isBlocked"]&&jQuery(e).find("#give_purchase_form_wrap").block({message:null,overlayCSS:{background:"#fff",opacity:.6}}),jQuery.post(give_scripts.ajaxurl+"?payment-mode="+i,{action:"give_load_gateway",give_total:t,give_form_id:o,give_payment_mode:i},function(i){jQuery(e).unblock(),jQuery(e).find("#give_purchase_form_wrap").html(i),jQuery(".give-no-js").hide(),jQuery(e).find("#give-payment-mode-wrap .give-loading-text").fadeOut(),setup_give_tooltips(),setup_form_loading_images(),jQuery(document).trigger("give_gateway_loaded",[i])})}function setup_give_tooltips(){jQuery('[data-tooltip!=""]').qtip({content:{attr:"data-tooltip"},style:{classes:"qtip-rounded qtip-tipsy"},position:{my:"bottom center",at:"top center"}})}function setup_form_loading_images(){jQuery(".give-loading-animation").css("background-image","url("+give_scripts.ajax_loader+")")}var give_scripts,give_global_vars;jQuery(document).ready(function(e){setup_give_tooltips(),setup_form_loading_images(),e(".give-loading-text").hide(),e("body").on("click",".give_checkout_register_login",function(i){var a=e(this),t={action:a.data("action")},o=e(this).parents("form"),n=e(o).find("#give-login-account-wrap .give-loading-text");return n.show(),e.post(give_scripts.ajaxurl,t,function(i){e(o).find("#give_checkout_login_register").html("").html(i)}).done(function(){setup_form_loading_images(),n.hide()}),!1}),e(document).on("click","#give_login_fields input[type=submit]",function(i){i.preventDefault();var a=e(this).val(),t=e(this).parents("form");e(this).val(give_global_vars.purchase_loading),t.find("#give_login_fields .give-loading-animation").fadeIn();var o={action:"give_process_checkout_login",give_ajax:1,give_user_login:t.find("#give_user_login").val(),give_user_pass:t.find("#give_user_pass").val()};e.post(give_global_vars.ajaxurl,o,function(i){"success"==e.trim(i)?(t.find(".give_errors").remove(),give_load_gateway(t,t.find(".give-gateway-option-selected input").val())):(t.find("#give_login_fields input[type=submit]").val(a),t.find(".give-loading-animation").fadeOut(),t.find(".give_errors").remove(),t.find("#give-user-login-submit").before(i))})}),e("select#give-gateway, input.give-gateway").on("change",function(i){i.preventDefault();var a=e(this).val();return"0"==a?(console.log("There was a problem loading the selected gateway"),!1):(give_load_gateway(e(this).parents("form"),a),!1)}),e("body").on("click touchend","#give-purchase-button",function(i){var a=e(this).parents("form.give-form"),t=a.find("#give_purchase_submit .give-loading-animation");t.fadeIn();var o=a.get(0);if("function"==typeof o.checkValidity&&o.checkValidity()===!1)return void t.fadeOut();i.preventDefault();var n=e(this).val();e(this).val(give_global_vars.purchase_loading),e.post(give_global_vars.ajaxurl,a.serialize()+"&action=give_process_checkout&give_ajax=true",function(i){"success"==e.trim(i)?(a.find(".give_errors").remove(),e(o).submit()):(a.find("#give-purchase-button").val(n),t.fadeOut(),a.find(".give_errors").remove(),a.find("#give_purchase_submit").before(i))})})});
var give_scripts,give_global_vars;jQuery(function(e){function a(){n=e("#card_number"),o=e("#card_cvc"),r=e("#card_exp_month"),l=e("#card_exp_year"),d=e("form.give-form"),n.payment("formatCardNumber"),o.payment("formatCardCVC")}function t(a){var t=a.parents("form"),i=a.val(),n=a.data("price-id"),o=t.find(".give-currency-symbol").text();if(e(a).parents(".give-donation-levels-wrap").find(".give-default-level").removeClass("give-default-level"),e(a).addClass("give-default-level"),t.find("#give-amount").removeClass("invalid-amount"),"custom"===i)return t.find("#give-amount").val("").focus(),!1;n||(n=a.find("option:selected").data("price-id")),t.find(".give-updating-price-loader").stop().fadeIn().fadeOut(),t.find("input[name=give-price-id]").val(n),t.find("input#give-amount").val(i),t.find("span#give-amount").text(i);var r=o+i;"after"==give_global_vars.currency_pos&&(r=i+o),t.find(".give-final-total-amount").data("total",i).text(r)}var i=e(document);i.on("change","#give_cc_address input.card_state, #give_cc_address select",function(){var a=e(this),t=a.parents("form");if("card_state"!=a.attr("id")){t.find("#card_state").empty().append('<option value="1">'+give_global_vars.general_loading+"</option>").prop("disabled",!0);var n={action:"give_get_states",country:a.val(),field_name:"card_state"};e.ajax({type:"POST",data:n,url:give_global_vars.ajaxurl,xhrFields:{withCredentials:!0},success:function(e){if("nostates"==e){var a='<input type="text" name="card_state" class="cart-state give-input required" value=""/>';t.find('input[name="card_state"], select[name="card_state"]').replaceWith(a)}else t.find('input[name="card_state"], select[name="card_state"]').replaceWith(e);i.trigger("give_checkout_billing_address_updated",[e])}}).fail(function(e){window.console&&window.console.log&&console.log(e)})}return!1});var n,o,r,l,d;a(),i.on("give_gateway_loaded",function(){a()}),e.fn.toggleError=function(e){return this.toggleClass("error",e),this.toggleClass("valid",!e),this},i.on("keyup change","#card_number, #card_cvc, #card_exp_month, #card_exp_year",function(){var a=e(this),t=a.attr("id"),i=e.payment.cardType(n.val());if("card_number"===t){var s=d.find(".card-type");null===i?(s.removeClass().addClass("off card-type"),a.removeClass("valid").addClass("error")):s.removeClass("off").addClass(i),n.toggleError(!e.payment.validateCardNumber(n.val()))}if("card_cvc"===t&&o.toggleError(!e.payment.validateCardCVC(o.val(),i)),"card_exp_month"===t||"card_exp_year"===t){var v=parseInt(r.val(),10),c=parseInt(l.val(),10);r.toggleError(!e.payment.validateCardExpiry(v,c)),l.toggleError(!e.payment.validateCardExpiry(v,c))}}),i.on("submit","#give_payment_mode",function(){var a=e("#give-gateway option:selected").val();return 0==a?(alert(give_global_vars.no_gateway),!1):void 0}),i.on("click","#give-payment-mode-select input",function(){e("#give-payment-mode-select label.give-gateway-option-selected").removeClass("give-gateway-option-selected"),e("#give-payment-mode-select input:checked").parent().addClass("give-gateway-option-selected")}),i.on("focus",".give-donation-amount .give-text-input",function(a){var t=e(this).parents("form");e(this).removeClass("invalid-amount"),e(this).maskMoney({decimal:give_global_vars.decimal_separator,thousands:give_global_vars.thousands_separator}),e(this).data("amount",e(this).val()),e(this).parent(".give-donation-amount").addClass("give-custom-amount-focus-in"),t.find(".give-default-level, .give-radio-input").removeClass("give-default-level"),t.find(".give-btn-level-custom").addClass("give-default-level"),t.find(".give-radio-input").prop("checked",!1),t.find(".give-radio-input.give-radio-level-custom").prop("checked",!0),t.find(".give-select-level").prop("selected",!1),t.find(".give-select-level .give-donation-level-custom").prop("selected",!0)}),i.on("blur",".give-donation-amount .give-text-input",function(a){var t=e(this).data("amount"),i=e(this).val(),n=give_global_vars.currency_sign+i;"after"==give_global_vars.currency_pos&&(n=i+give_global_vars.currency_sign),(!i||0>=i)&&e(this).addClass("invalid-amount"),t!==i&&(e(this).parents("form").find(".give-final-total-amount").data("total",i).text(n),e(this).next(".give-updating-price-loader").find(".give-loading-animation").css("background-image","url("+give_scripts.ajax_loader+")"),e(this).next(".give-updating-price-loader").stop().fadeIn().fadeOut()),e(this).parent(".give-donation-amount").removeClass("give-custom-amount-focus-in")}),i.on("click touchend",".give-donation-level-btn",function(a){a.preventDefault(),t(e(this))}),i.on("click touchend",".give-radio-input-level",function(a){t(e(this))}),i.on("change",".give-select-level",function(a){t(e(this))})});
=======
<<<<<<< HEAD
function give_load_gateway(e,i){var a=jQuery(e).find("#give-payment-mode-select .give-loading-animation"),t=jQuery(e).find("#give-amount").val(),o=jQuery(e).find('input[name="give-form-id"]').val();a.parent().fadeIn();var n=jQuery(e).data();1!=n["blockUI.isBlocked"]&&jQuery(e).find("#give_purchase_form_wrap").block({message:null,overlayCSS:{background:"#fff",opacity:.6}}),jQuery.post(give_scripts.ajaxurl+"?payment-mode="+i,{action:"give_load_gateway",give_total:t,give_form_id:o,give_payment_mode:i},function(i){jQuery(e).unblock(),jQuery(e).find("#give_purchase_form_wrap").html(i),jQuery(".give-no-js").hide(),jQuery(e).find("#give-payment-mode-wrap .give-loading-text").fadeOut(),setup_give_tooltips(),setup_form_loading_images()})}function setup_give_tooltips(){jQuery('[data-tooltip!=""]').qtip({content:{attr:"data-tooltip"},style:{classes:"qtip-rounded qtip-tipsy"},position:{my:"bottom center",at:"top center"}})}function setup_form_loading_images(){jQuery(".give-loading-animation").css("background-image","url("+give_scripts.ajax_loader+")")}var give_scripts,give_global_vars;jQuery(document).ready(function(e){setup_give_tooltips(),setup_form_loading_images(),e(".give-loading-text").hide(),e("body").on("click",".give_checkout_register_login",function(i){var a=e(this),t={action:a.data("action")},o=e(this).parents("form"),n=e(o).find("#give-login-account-wrap .give-loading-text");return n.show(),e.post(give_scripts.ajaxurl,t,function(i){e(o).find("#give_checkout_login_register").html("").html(i)}).done(function(){setup_form_loading_images(),n.hide()}),!1}),e(document).on("click","#give_login_fields input[type=submit]",function(i){i.preventDefault();var a=e(this).val(),t=e(this).parents("form");e(this).val(give_global_vars.purchase_loading),t.find("#give_login_fields .give-loading-animation").fadeIn();var o={action:"give_process_checkout_login",give_ajax:1,give_user_login:t.find("#give_user_login").val(),give_user_pass:t.find("#give_user_pass").val()};e.post(give_global_vars.ajaxurl,o,function(i){"success"==e.trim(i)?(t.find(".give_errors").remove(),give_load_gateway(t,t.find(".give-gateway-option-selected input").val())):(t.find("#give_login_fields input[type=submit]").val(a),t.find(".give-loading-animation").fadeOut(),t.find(".give_errors").remove(),t.find("#give-user-login-submit").before(i))})}),e("select#give-gateway, input.give-gateway").on("change",function(i){i.preventDefault();var a=e(this).val();return"0"==a?(console.log("There was a problem loading the selected gateway"),!1):(give_load_gateway(e(this).parents("form"),a),!1)}),e("body").on("click touchend","#give-purchase-button",function(i){var a=e(this).parents("form.give-form"),t=a.find("#give_purchase_submit .give-loading-animation");t.fadeIn();var o=a.get(0);if("function"==typeof o.checkValidity&&o.checkValidity()===!1)return void t.fadeOut();i.preventDefault();var n=e(this).val();e(this).val(give_global_vars.purchase_loading),e.post(give_global_vars.ajaxurl,a.serialize()+"&action=give_process_checkout&give_ajax=true",function(i){"success"==e.trim(i)?(a.find(".give_errors").remove(),e(o).submit()):(a.find("#give-purchase-button").val(n),t.fadeOut(),a.find(".give_errors").remove(),a.find("#give_purchase_submit").before(i))})})});
var give_scripts,give_global_vars;jQuery(function(e){function a(a){var t=a.parents("form"),i=a.val(),n=a.data("price-id"),r=t.find(".give-currency-symbol").text();if(e(a).parents(".give-donation-levels-wrap").find(".give-default-level").removeClass("give-default-level"),e(a).addClass("give-default-level"),t.find("#give-amount").removeClass("invalid-amount"),"custom"===i)return t.find("#give-amount").val("").focus(),!1;n||(n=a.find("option:selected").data("price-id")),t.find(".give-updating-price-loader").stop().fadeIn().fadeOut(),t.find("input[name=give-price-id]").val(n),t.find("input#give-amount").val(i),t.find("span#give-amount").text(i);var o=r+i;"after"==give_global_vars.currency_pos&&(o=i+r),t.find(".give-final-total-amount").data("total",i).text(o)}var t=e(document);t.on("change","#give_cc_address input.card_state, #give_cc_address select",function(){var a=e(this),t=a.parents("form");if("card_state"!=a.attr("id")){t.find("#card_state").empty().append('<option value="1">'+give_global_vars.general_loading+"</option>").prop("disabled",!0);var i={action:"give_get_states",country:a.val(),field_name:"card_state"};e.ajax({type:"POST",data:i,url:give_global_vars.ajaxurl,xhrFields:{withCredentials:!0},success:function(a){if("nostates"==a){var i='<input type="text" name="card_state" class="cart-state give-input required" value=""/>';t.find('input[name="card_state"], select[name="card_state"]').replaceWith(i)}else t.find('input[name="card_state"], select[name="card_state"]').replaceWith(a);e("body").trigger("give_checkout_billing_address_updated",[a])}}).fail(function(e){window.console&&window.console.log&&console.log(e)})}return!1});var i=e("#card_number"),n=e("#card_cvc"),r=e("#card_exp_month"),o=e("#card_exp_year"),l=e("form.give-form");i.payment("formatCardNumber"),n.payment("formatCardCVC"),e.fn.toggleError=function(e){return this.toggleClass("error",e),this.toggleClass("valid",!e),this},t.on("keyup change","#card_number, #card_cvc, #card_exp_month, #card_exp_year",function(){var a=e(this),t=a.attr("id"),d=e.payment.cardType(i.val());if("card_number"===t){var s=l.find(".card-type");null===d?(s.removeClass().addClass("off card-type"),a.removeClass("valid").addClass("error")):s.removeClass("off").addClass(d),i.toggleError(!e.payment.validateCardNumber(i.val()))}if("card_cvc"===t&&n.toggleError(!e.payment.validateCardCVC(n.val(),d)),"card_exp_month"===t||"card_exp_year"===t){var v=parseInt(r.val(),10),c=parseInt(o.val(),10);r.toggleError(!e.payment.validateCardExpiry(v,c)),o.toggleError(!e.payment.validateCardExpiry(v,c))}}),t.on("submit","#give_payment_mode",function(){var a=e("#give-gateway option:selected").val();return 0==a?(alert(give_global_vars.no_gateway),!1):void 0}),t.on("click","#give-payment-mode-select input",function(){e("#give-payment-mode-select label.give-gateway-option-selected").removeClass("give-gateway-option-selected"),e("#give-payment-mode-select input:checked").parent().addClass("give-gateway-option-selected")}),t.on("focus",".give-donation-amount .give-text-input",function(a){var t=e(this).parents("form");e(this).removeClass("invalid-amount"),e(this).maskMoney({decimal:give_global_vars.decimal_separator,thousands:give_global_vars.thousands_separator}),e(this).data("amount",e(this).val()),e(this).parent(".give-donation-amount").addClass("give-custom-amount-focus-in"),t.find(".give-default-level, .give-radio-input").removeClass("give-default-level"),t.find(".give-btn-level-custom").addClass("give-default-level"),t.find(".give-radio-input").prop("checked",!1),t.find(".give-radio-input.give-radio-level-custom").prop("checked",!0),t.find(".give-select-level").prop("selected",!1),t.find(".give-select-level .give-donation-level-custom").prop("selected",!0)}),t.on("blur",".give-donation-amount .give-text-input",function(a){var t=e(this).data("amount"),i=e(this).val(),n=give_global_vars.currency_sign+i;"after"==give_global_vars.currency_pos&&(n=i+give_global_vars.currency_sign),(!i||0>=i)&&e(this).addClass("invalid-amount"),t!==i&&(e(this).parents("form").find(".give-final-total-amount").data("total",i).text(n),e(this).next(".give-updating-price-loader").find(".give-loading-animation").css("background-image","url("+give_scripts.ajax_loader+")"),e(this).next(".give-updating-price-loader").stop().fadeIn().fadeOut()),e(this).parent(".give-donation-amount").removeClass("give-custom-amount-focus-in")}),t.on("click touchend",".give-donation-level-btn",function(t){t.preventDefault(),a(e(this))}),t.on("click touchend",".give-radio-input-level",function(t){a(e(this))}),t.on("change",".give-select-level",function(t){a(e(this))})});
=======
function give_load_gateway(e,i){var a=jQuery(e).find("#give-payment-mode-select .give-loading-animation"),t=jQuery(e).find("#give-amount").val(),o=jQuery(e).find('input[name="give-form-id"]').val();a.parent().fadeIn();var n=jQuery(e).data();1!=n["blockUI.isBlocked"]&&jQuery(e).find("#give_purchase_form_wrap").block({message:null,overlayCSS:{background:"#fff",opacity:.6}}),jQuery.post(give_scripts.ajaxurl+"?payment-mode="+i,{action:"give_load_gateway",give_total:t,give_form_id:o,give_payment_mode:i},function(i){jQuery(e).unblock(),jQuery(e).find("#give_purchase_form_wrap").html(i),jQuery(".give-no-js").hide(),jQuery(e).find("#give-payment-mode-wrap .give-loading-text").fadeOut(),setup_give_tooltips(),setup_form_loading_images(),jQuery(document).trigger("give_gateway_loaded",[i])})}function setup_give_tooltips(){jQuery('[data-tooltip!=""]').qtip({content:{attr:"data-tooltip"},style:{classes:"qtip-rounded qtip-tipsy"},position:{my:"bottom center",at:"top center"}})}function setup_form_loading_images(){jQuery(".give-loading-animation").css("background-image","url("+give_scripts.ajax_loader+")")}var give_scripts,give_global_vars;jQuery(document).ready(function(e){setup_give_tooltips(),setup_form_loading_images(),e(".give-loading-text").hide(),e("body").on("click",".give_checkout_register_login",function(i){var a=e(this),t={action:a.data("action")},o=e(this).parents("form"),n=e(o).find("#give-login-account-wrap .give-loading-text");return n.show(),e.post(give_scripts.ajaxurl,t,function(i){e(o).find("#give_checkout_login_register").html("").html(i)}).done(function(){setup_form_loading_images(),n.hide()}),!1}),e(document).on("click","#give_login_fields input[type=submit]",function(i){i.preventDefault();var a=e(this).val(),t=e(this).parents("form");e(this).val(give_global_vars.purchase_loading),t.find("#give_login_fields .give-loading-animation").fadeIn();var o={action:"give_process_checkout_login",give_ajax:1,give_user_login:t.find("#give_user_login").val(),give_user_pass:t.find("#give_user_pass").val()};e.post(give_global_vars.ajaxurl,o,function(i){"success"==e.trim(i)?(t.find(".give_errors").remove(),give_load_gateway(t,t.find(".give-gateway-option-selected input").val())):(t.find("#give_login_fields input[type=submit]").val(a),t.find(".give-loading-animation").fadeOut(),t.find(".give_errors").remove(),t.find("#give-user-login-submit").before(i))})}),e("select#give-gateway, input.give-gateway").on("change",function(i){i.preventDefault();var a=e(this).val();return"0"==a?(console.log("There was a problem loading the selected gateway"),!1):(give_load_gateway(e(this).parents("form"),a),!1)}),e("body").on("click touchend","#give-purchase-button",function(i){var a=e(this).parents("form.give-form"),t=a.find("#give_purchase_submit .give-loading-animation");t.fadeIn();var o=a.get(0);if("function"==typeof o.checkValidity&&o.checkValidity()===!1)return void t.fadeOut();i.preventDefault();var n=e(this).val();e(this).val(give_global_vars.purchase_loading),e.post(give_global_vars.ajaxurl,a.serialize()+"&action=give_process_checkout&give_ajax=true",function(i){"success"==e.trim(i)?(a.find(".give_errors").remove(),e(o).submit()):(a.find("#give-purchase-button").val(n),t.fadeOut(),a.find(".give_errors").remove(),a.find("#give_purchase_submit").before(i))})})});
var give_scripts,give_global_vars;jQuery(function(e){function a(){n=e("#card_number"),o=e("#card_cvc"),r=e("#card_exp_month"),l=e("#card_exp_year"),d=e("form.give-form"),n.payment("formatCardNumber"),o.payment("formatCardCVC")}function t(a){var t=a.parents("form"),i=a.val(),n=a.data("price-id"),o=t.find(".give-currency-symbol").text();if(e(a).parents(".give-donation-levels-wrap").find(".give-default-level").removeClass("give-default-level"),e(a).addClass("give-default-level"),t.find("#give-amount").removeClass("invalid-amount"),"custom"===i)return t.find("#give-amount").val("").focus(),!1;n||(n=a.find("option:selected").data("price-id")),t.find(".give-updating-price-loader").stop().fadeIn().fadeOut(),t.find("input[name=give-price-id]").val(n),t.find("input#give-amount").val(i),t.find("span#give-amount").text(i);var r=o+i;"after"==give_global_vars.currency_pos&&(r=i+o),t.find(".give-final-total-amount").data("total",i).text(r)}var i=e(document);i.on("change","#give_cc_address input.card_state, #give_cc_address select",function(){var a=e(this),t=a.parents("form");if("card_state"!=a.attr("id")){t.find("#card_state").empty().append('<option value="1">'+give_global_vars.general_loading+"</option>").prop("disabled",!0);var n={action:"give_get_states",country:a.val(),field_name:"card_state"};e.ajax({type:"POST",data:n,url:give_global_vars.ajaxurl,xhrFields:{withCredentials:!0},success:function(e){if("nostates"==e){var a='<input type="text" name="card_state" class="cart-state give-input required" value=""/>';t.find('input[name="card_state"], select[name="card_state"]').replaceWith(a)}else t.find('input[name="card_state"], select[name="card_state"]').replaceWith(e);i.trigger("give_checkout_billing_address_updated",[e])}}).fail(function(e){window.console&&window.console.log&&console.log(e)})}return!1});var n,o,r,l,d;a(),i.on("give_gateway_loaded",function(){a()}),e.fn.toggleError=function(e){return this.toggleClass("error",e),this.toggleClass("valid",!e),this},i.on("keyup change","#card_number, #card_cvc, #card_exp_month, #card_exp_year",function(){var a=e(this),t=a.attr("id"),i=e.payment.cardType(n.val());if("card_number"===t){var s=d.find(".card-type");null===i?(s.removeClass().addClass("off card-type"),a.removeClass("valid").addClass("error")):s.removeClass("off").addClass(i),n.toggleError(!e.payment.validateCardNumber(n.val()))}if("card_cvc"===t&&o.toggleError(!e.payment.validateCardCVC(o.val(),i)),"card_exp_month"===t||"card_exp_year"===t){var v=parseInt(r.val(),10),c=parseInt(l.val(),10);r.toggleError(!e.payment.validateCardExpiry(v,c)),l.toggleError(!e.payment.validateCardExpiry(v,c))}}),i.on("submit","#give_payment_mode",function(){var a=e("#give-gateway option:selected").val();return 0==a?(alert(give_global_vars.no_gateway),!1):void 0}),i.on("click","#give-payment-mode-select input",function(){e("#give-payment-mode-select label.give-gateway-option-selected").removeClass("give-gateway-option-selected"),e("#give-payment-mode-select input:checked").parent().addClass("give-gateway-option-selected")}),i.on("focus",".give-donation-amount .give-text-input",function(a){var t=e(this).parents("form");e(this).removeClass("invalid-amount"),e(this).maskMoney({decimal:give_global_vars.decimal_separator,thousands:give_global_vars.thousands_separator}),e(this).data("amount",e(this).val()),e(this).parent(".give-donation-amount").addClass("give-custom-amount-focus-in"),t.find(".give-default-level, .give-radio-input").removeClass("give-default-level"),t.find(".give-btn-level-custom").addClass("give-default-level"),t.find(".give-radio-input").prop("checked",!1),t.find(".give-radio-input.give-radio-level-custom").prop("checked",!0),t.find(".give-select-level").prop("selected",!1),t.find(".give-select-level .give-donation-level-custom").prop("selected",!0)}),i.on("blur",".give-donation-amount .give-text-input",function(a){var t=e(this).data("amount"),i=e(this).val(),n=give_global_vars.currency_sign+i;"after"==give_global_vars.currency_pos&&(n=i+give_global_vars.currency_sign),(!i||0>=i)&&e(this).addClass("invalid-amount"),t!==i&&(e(this).parents("form").find(".give-final-total-amount").data("total",i).text(n),e(this).next(".give-updating-price-loader").find(".give-loading-animation").css("background-image","url("+give_scripts.ajax_loader+")"),e(this).next(".give-updating-price-loader").stop().fadeIn().fadeOut()),e(this).parent(".give-donation-amount").removeClass("give-custom-amount-focus-in")}),i.on("click touchend",".give-donation-level-btn",function(a){a.preventDefault(),t(e(this))}),i.on("click touchend",".give-radio-input-level",function(a){t(e(this))}),i.on("change",".give-select-level",function(a){t(e(this))})});
>>>>>>> f7821fb... trigger ccform validation on gateway change
>>>>>>> feature/ccformatting
var give_scripts;jQuery(document).ready(function(e){var n=e("body");n.on("click",".give-btn-reveal",function(n){n.preventDefault();var i=e(this),t=e(this).parents("form");return i.hide(),t.find("#give-payment-mode-select, #give_purchase_form_wrap").slideDown(),!1}),n.on("click",".give-btn-modal",function(n){n.preventDefault();var i=e(this).parents("div.give-form-wrap"),t=i.find("#give-amount"),o=t.val();return!o||0>=o?(t.focus(),!1):void e.magnificPopup.open({mainClass:"give-modal",items:{src:i,type:"inline"},callbacks:{open:function(){e(".mfp-content").outerWidth()>=500&&e(".mfp-content").addClass("give-responsive-mfp-content")},close:function(){i.removeClass("mfp-hide")}}})})});