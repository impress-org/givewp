...
function give_open_form_modal(e,t){var i="#give_purchase_form_wrap, #give-payment-mode-select, .mfp-close, .give-hidden";jQuery.magnificPopup.open({mainClass:give_global_vars.magnific_options.main_class,closeOnBgClick:give_global_vars.magnific_options.close_on_bg_click,fixedContentPos:!0,fixedBgPos:!0,items:{src:t,type:"inline"},callbacks:{beforeOpen:function(){if(e.hasClass("give-display-button-only")&&!t.data("content")){var i=jQuery(".give-form-content-wrap",e),n=jQuery(".give-form-title",e),a=jQuery(".give-goal-progress",e),r=jQuery(">.give_error",e),l=jQuery(".give_errors",e);i.length&&!jQuery(".give-form-content-wrap",t).length&&(i.hasClass("give_post_form-content")?t.append(i):t.prepend(i)),l.length&&!jQuery(".give_errors",t).length&&l.each(function(e,i){t.prepend(jQuery(i))}),r.length&&!jQuery(">.give_error",t).length&&r.each(function(e,i){t.prepend(jQuery(i))}),a.length&&!jQuery(".give-goal-progress",t).length&&t.prepend(a),n.length&&!jQuery(".give-form-title",t).length&&t.prepend(n),t.data("content","loaded")}},open:function(){var n=jQuery(".mfp-content");n.outerWidth()>=500&&n.addClass("give-responsive-mfp-content"),e.hasClass("give-display-button-only")&&(i=t.children().not(".give-hidden, .give-btn-modal")),t.children().not(i).hide()},close:function(){t.removeClass("mfp-hide"),t.children().not(i).show()}}})}function give_fl_trigger(){give_float_labels instanceof FloatLabels?give_float_labels.rebuild():give_float_labels=new FloatLabels(".float-labels-enabled",{customEvent:give_fl_custom_events,exclude:'#give-amount, .give-select-level, .multiselect, [type="url"]',prioritize:"placeholder",style:"give"})}function give_fl_custom_events(e){var t=jQuery(e);t.hasClass("card-number")&&t.after('<span class="off card-type"/>')}function give_change_html5_form_field_validation_message(){var e,t=jQuery(".give-form");t.length&&jQuery.each(t,function(t,i){e=jQuery("input",i),e.length&&jQuery.each(e,function(e,t){t=jQuery(t).get(0),give_global_vars.form_translation.hasOwnProperty(t.name)&&(t.oninvalid=function(e){e.target.setCustomValidity(""),e.target.validity.valid||e.target.setCustomValidity(give_global_vars.form_translation[t.name])})})})}var give_scripts,give_float_labels;jQuery(function(e){var t=e(document);give_fl_trigger(),give_change_html5_form_field_validation_message(),t.on("give_gateway_loaded",function(e,t,i){give_fl_trigger()}),t.on("give_checkout_billing_address_updated",function(t,i,n){var a=e("form#"+n);if(a.hasClass("float-labels-enabled")){var r=a.find("#give-card-state-wrap"),l=r.find("#card_state"),o=r.find('label[for="card_state"]');o=o.length?o.text().replace(/[*:]/g,"").trim():"","nostates"===i?l.attr("placeholder",o).parent().removeClass("styled select"):(l.children().first().text(o),l.parent().addClass("styled select")),l.parent().removeClass("fl-is-active"),give_fl_trigger()}}),t.on("click",".give-btn-reveal",function(t){t.preventDefault();var i=e(this),n=e(this).parents("form"),a="#give-payment-mode-select",r=e(a),l="";return i.hide(),e("li",r).length>1&&(l=a+", "),n.find(l+"#give_purchase_form_wrap").slideDown(),!1}),t.on("click",".give-btn-modal",function(t){t.preventDefault();var i=e(this).parents("div.give-form-wrap"),n=i.find("form.give-form"),a=n.find("#give-amount"),r=a.val();return!r||r<=0?(a.focus(),!1):void give_open_form_modal(i,n)});var i=jQuery('.give_notice[data-auto-dismissible="1"]');i.length&&i.each(function(t,i){i=e(i),window.setTimeout(function(){i.slideUp()},i.data("dismiss-interval"))})});