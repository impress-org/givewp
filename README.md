...
| `npm run test` |  Run jest tests. Make sure that you docker container is running before running this command. [Read more](https://github.com/impress-org/give/tree/readme-spice/tests/e2e) |
