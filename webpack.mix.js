...
mix.setPublicPath('assets/dist')
    ...
    .ts('src/Donations/resources/DonationsListTable/index.tsx', 'js/give-admin-donations.js')
    .ts('src/Donations/resources/DonationDetails/index.tsx', 'js/give-admin-donation-details.js')
