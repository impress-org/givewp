...
const config = {
	...
	entry: {
		...
		'paypal-advanced-card-fields': [ './src/PaymentGateways/PayPalCommerce/assets/js/index.js', './src/PaymentGateways/PayPalCommerce/assets/css/paypal-advanced-card-fields.scss' ],
	},
	output: {
