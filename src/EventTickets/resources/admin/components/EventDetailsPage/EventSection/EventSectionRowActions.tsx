 ...
 * @unreleased
 */
export function EventSectionRowActions({item, openEditModal, setUpdateErrors}) {
        ...
        if (confirmDelete) {
            if (await deleteItem(item.id)) {
                window.location.href =
                    window.GiveEventTicketsDetails.adminUrl + 'edit.php?post_type=give_forms&page=give-event-tickets';
            }
        }
    };
