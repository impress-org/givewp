...
abstract class ListTable implements Arrayable
{
     ...
     *
     * @since TBD Catch Throwable, not just Exception. A cell filter registered by another plugin can
     *            raise a TypeError, which is an Error and so used to escape this guard and fail the
     *            whole request instead of a single cell.
     * @since 2.24.1
     *
     * @return mixed
     */
