...
interface SubscriptionModuleInterface
{
     ...
     * Note: You can use "givewp_create_subscription_{$gatewayId}_gateway_data" filter hook to pass additional data for gateway which helps/require to process initial subscription transaction.
     ...
     *
     * @unreleased Add third param to function to pass gateway data to process transaction
     * @since 2.18.0
     *
