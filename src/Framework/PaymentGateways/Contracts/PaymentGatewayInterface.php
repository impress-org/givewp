...
interface PaymentGatewayInterface extends SubscriptionModuleInterface
{
     ...
     * Note: You can use "givewp_create_payment_{$gatewayId}_gateway_data" filter hook to pass additional data for gateway which helps/require to process transaction.
     ...
     *
     * @unreleased Add second param to function to pass gateway data to process transaction
     * @since 2.18.0
     *
