...
class StripeWebhookRecievedRoute implements RestRoute {
	...
	public function handleRequest( WP_REST_Request $request ) {
		...
		return get_option( 'give_settings' )['gateways'];
		...
		$webhookRecieved = give_get_option( 'give_stripe_last_webhook_received_timestamp', false );

		return [
			'webhookRecieved' => $webhookRecieved,
		];
	}
