...
echo '<div class="givewp-donation-options inner-panel">
    <div>
        <img src="' . esc_url(GIVE_PLUGIN_URL . 'assets/dist/images/list-table/light-bulb-icon.svg') . '" alt="light-bulb-icon" />
        <p>';
_e(
...
echo '<img src="' . esc_url(GIVE_PLUGIN_URL . 'assets/dist/images/list-table/external-link-icon.svg') . '" alt="external-link" />
        </a>
    </div>
