...
add_action( 'give_embed_head', array( $this, 'give_ft_sequoia_page_styles' ) );
add_action( 'give_embed_footer', array( $this, 'give_ft_sequoia_page_scripts' ) );
...
function give_ft_sequoia_page_styles() {
	// echo getStyleTag( $this->get_frontend_stylesheet_uri() );
	...
	echo getLocalizedScript( 'give_global_vars', $this->get_public_data() );
}
