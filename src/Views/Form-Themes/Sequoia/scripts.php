...
function give_ft_sequoia_enqueue_scripts() {
	wp_enqueue_style( 'give-sequoia-theme-css', GIVE_PLUGIN_URL . 'assets/dist/css/give-sequoia-theme.css', array(), GIVE_VERSION );
	...
	wp_enqueue_script( 'give-sequoia-theme-js', GIVE_PLUGIN_URL . 'assets/dist/js/give-sequoia-theme.js', array(), GIVE_VERSION, true );
