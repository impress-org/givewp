...
$primaryColor = ! empty($options[ 'primary_color' ])
    ...
    : '1E8CBE';
$primaryColor = preg_replace('/[^0-9A-Fa-f]/', '', $primaryColor);
...
<div style="
    ...
    <div style="
        ...
        height: 90px;
        width: 90px;
        background-image: url(<?php echo $loader; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG data URI; the only interpolated value, $primaryColor, is stripped to hex-only characters above. esc_url() would strip the data: URI entirely. ?>);
