	...
	'thank-you'           => [
		...
		'fields' => [
			...
			[
				...
				'type'       => 'text',
				'attributes' => [
					'placeholder' => __( 'Help spread the word by sharing your support your friends and followers!', 'give' ),
				],
				'default'    => __( 'Help spread the word by sharing your support your friends and followers!', 'give' ),
			],
			[
				'id'         => 'twitter_message',
