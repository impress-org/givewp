...
export default function ActionContainer({label, value, type, toggleModal}: ActionContainer) {
    return (
        <button type={'button'} onClick={(event) => toggleModal(event)} className={styles.actionContainer}>
