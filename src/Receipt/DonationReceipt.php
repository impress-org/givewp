...
class DonationReceipt extends Receipt
{
    ...
    private function addDonorSection()
    {
        ...
        $hasAddress = (bool)trim(
            str_replace(',', '', strip_tags($billingAddressLineItem['value']))
        ); // Remove formatting from address.
    ...
    private function getDonationAmountLineItem()
    {
        $value = filterCurrency(
            formatAmount(getDonationMetaData($this->donationId, '_give_payment_total', true),
