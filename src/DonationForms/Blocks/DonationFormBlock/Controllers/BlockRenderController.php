...
class BlockRenderController
{
    ...
    public function render(array $attributes)
    {
        ...
        $formDesign = $donationForm->settings->designId;
         ...
         */
        return "<div class='root-data-givewp-embed' data-form-design='$formDesign' data-form-locale='$locale' data-form-url='$formUrl' data-form-view-url='$formViewUrl' data-src='$viewUrl' data-givewp-embed-id='$embedId' data-form-format='$blockAttributes->formFormat' data-open-form-button='$blockAttributes->openFormButton'></div>";
    }
