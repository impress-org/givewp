...
export const ViewIcon = () => (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            stroke="#000" strokeWidth="1.167" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M7 8.751a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5z" stroke="#000" strokeWidth="1.167"
...
export const CloseIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M17 7 7 17M7 7l10 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
