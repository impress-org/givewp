...
class AjaxRequestHandler {
	...
	public function onBoardedUserAjaxRequestHandler() {
		$partnerLinkInfo = get_option( onBoardingRedirectHandler::$partnerInfoOptionKey, [ 'nonce' => '' ] );
		...
		update_option( onBoardingRedirectHandler::$accessTokenOptionKey, $payPalResponse );
	...
	public function onGetPartnerUrlAjaxRequestHandler() {
		...
		update_option( onBoardingRedirectHandler::$partnerInfoOptionKey, $data );
