...
namespace Give\PaymentGateways\TheGivingBlock\Admin\CustomFields\GetStarted;
...
/**
 * Custom setting field for GiveWP > Payment Gateways > The Giving Block > Get Started.
 *
 * @unreleased
 */
...
{
    /**
     * Render the Get Started field content.
     *
     * @unreleased
     *
