...
class RenderOnboardingForm
{
    ...
    private function displayOnboardingForm()
    {
        ...
        <div class="give-tgb-card">
            <h2><?php esc_html_e('Connect to The Giving Block', 'give-tgb'); ?></h2>
            ...
            <div class="give-tgb-tab-content">
                ...
                <div id="tab-new" class="give-tgb-tab-panel <?php echo $defaultTab === 'new' ? 'active' : ''; ?>">
                    <div class="give-tgb-tab-description">
                        <h3><?php esc_html_e('Create New Organization', 'give-tgb'); ?></h3>
                        <p><?php esc_html_e('Submit a new organization for onboarding with The Giving Block. Fill out the form below with your organization details.', 'give-tgb'); ?></p>
                    </div>
                </div>
                ...
                <div id="tab-existing" class="give-tgb-tab-panel <?php echo $defaultTab === 'existing' ? 'active' : ''; ?>">
                    <div class="give-tgb-tab-description">
                        <h3><?php esc_html_e('Connect Existing Organization', 'give-tgb'); ?></h3>
                        <p><?php esc_html_e('I already have an Organization ID from The Giving Block. Enter your Organization ID below to connect your existing organization.', 'give-tgb'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div id="new-organization-form">
                <h3><?php esc_html_e('New Organization Information', 'give-tgb'); ?></h3>
            ...
            <form id="giveTgbOnboardingForm" method="post">
                ...
                <div class="give-tgb-form-section">
                    ...
                    <div class="give-tgb-form-row">
                        <div>
                            <label for="organizationName"><span class="required">*</span> <?php esc_html_e('Organization Name:', 'give-tgb'); ?></label>
                            <input type="text" id="organizationName" name="name" required>
                        </div>
                        <div>
                            <label for="organizationEin"><span class="required">*</span> <?php esc_html_e('EIN (Tax ID):', 'give-tgb'); ?></label>
                    ...
                    <div class="give-tgb-form-row">
                        <div>
                            <label for="organizationContactEmail"><span class="required">*</span> <?php esc_html_e('Contact Email:', 'give-tgb'); ?></label>
                            <input type="email" id="organizationContactEmail" name="contactEmail" required>
                        </div>
                        <div>
                            <label for="organizationWebsiteUrl"><?php esc_html_e('Website URL:', 'give-tgb'); ?></label>
                    ...
                    <div class="give-tgb-form-row">
                        ...
                        <div class="give-tgb-checkbox-row">
                            ...
                            <label for="isWebsiteProfileVisible"><?php esc_html_e('Make Website Profile Visible', 'give-tgb'); ?></label>
                        </div>
                    </div>
                </div>

                <div class="give-tgb-form-section">
                    <h3><?php esc_html_e('Address Information', 'give-tgb'); ?></h3>

                    <!-- Address Line 1 and 2 -->
                    <div class="give-tgb-form-row">
                        <div>
                            <label for="organizationAddress1"><span class="required">*</span> <?php esc_html_e('Address Line 1:', 'give-tgb'); ?></label>
                            <input type="text" id="organizationAddress1" name="address1" required>
                        </div>
                        <div>
                            <label for="organizationAddress2"><?php esc_html_e('Address Line 2:', 'give-tgb'); ?></label>
                    ...
                    <div class="give-tgb-form-row">
                        <div>
                            <label for="organizationCity"><span class="required">*</span> <?php esc_html_e('City:', 'give-tgb'); ?></label>
                            <input type="text" id="organizationCity" name="city" required>
                        </div>
                        <div>
                            <label for="organizationState"><span class="required">*</span> <?php esc_html_e('State:', 'give-tgb'); ?></label>
                            <select id="organizationState" name="state" required>
                                <option value=""><?php esc_html_e('Select State', 'give-tgb'); ?></option>
                                <?php
        ...
        ?>
                    ...
                    <div class="give-tgb-form-row">
                        <div>
                            <label for="organizationPostcode"><span class="required">*</span> <?php esc_html_e('Postal Code:', 'give-tgb'); ?></label>
                            <input type="text" id="organizationPostcode" name="postcode" required pattern="[0-9]{5}" maxlength="5" placeholder="12345">
                            <small><?php esc_html_e('Must be exactly 5 digits', 'give-tgb'); ?></small>
                        </div>
                        <div>
                            <label for="organizationCountry"><?php esc_html_e('Country:', 'give-tgb'); ?></label>
                            <input type="text" id="organizationCountry" name="country" value="USA" readonly>
                            <small class="give-tgb-country-notice"><?php esc_html_e('The Giving Block only accepts organizations from the USA', 'give-tgb'); ?></small>
                        </div>
                    </div>
                </div>

                <div class="give-tgb-submit-row">
                    <input type="button" name="submit" id="submitOnboarding" class="give-tgb-button button-secondary" value="<?php esc_attr_e('Submit Organization for Onboarding', 'give-tgb'); ?>">
            ...
            <div id="existing-organization-form" style="display: none;">
                <h3><?php esc_html_e('Connect Existing Organization', 'give-tgb'); ?></h3>
                <p><?php esc_html_e('Enter your Organization ID from The Giving Block to connect your existing organization.', 'give-tgb'); ?></p>
                ...
                <form id="giveTgbExistingOrganizationForm" method="post">
                    ...
                    <div class="give-tgb-form-section">
                        <div class="give-tgb-form-row">
                            <div>
                                <label for="existingOrganizationId"><span class="required">*</span> <?php esc_html_e('Organization ID:', 'give-tgb'); ?></label>
                                ...
                                <small><?php esc_html_e('Enter the Organization ID provided by The Giving Block.', 'give-tgb'); ?></small>
                            </div>
                        </div>
                    </div>

                    <div class="give-tgb-submit-row">
                        <input type="button" name="submit" id="submitExistingOrganization" class="give-tgb-button button-secondary" value="<?php esc_attr_e('Connect Organization', 'give-tgb'); ?>">
