		...
		<div class="give-stripe-per-form-options">
			...
			<div class="give-stripe-per-form-option-field give-stripe-boxshadow-option-wrap <?php echo 'multi' === $value ? 'give-stripe-boxshadow-option-wrap__selected' : ''; ?>">
				...
				<label class="give-stripe-per-form-option-label">
					...
					<span class="give-stripe-per-form-description"><?php esc_html_e( 'Donations are processed through the account selected below. Global Settings are overridden for this form.',
							'give' ); ?></span>
