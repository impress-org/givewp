...
class CreditCardSettingField {
	...
	private function getRadioButtons( $field, $value ) {
		...
		<div class="give-stripe-credit-card-options">
			<div class="give-stripe-cc-option-field give-stripe-boxshadow-option-wrap give-stripe-boxshadow-option-wrap__selected">
			...
			<div class="give-stripe-cc-option-field give-stripe-boxshadow-option-wrap">
				<label>
					<input
						name="stripe_cc_fields_format"
						value="multi"
