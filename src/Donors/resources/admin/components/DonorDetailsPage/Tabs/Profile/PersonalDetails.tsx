    ...
    return (
        <div className={styles.section}>
            <div className={styles.leftColumn}>
                <div className={styles.sectionTitle}>{__('Personal Details', 'give')}</div>
            ...
            <div className={styles.rightColumn}>
                <div className={styles.sectionField}>
                    <div className={styles.sectionSubtitle}>{__('Name', 'give')}</div>
                ...
                <div className={styles.sectionField}>
                    <div className={styles.sectionSubtitle}>{__('Phone', 'give')}</div>
                ...
                <div className={styles.sectionField}>
                    <div className={styles.sectionSubtitle}>{__('Company name', 'give')}</div>
