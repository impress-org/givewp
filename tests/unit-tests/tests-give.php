...
class Tests_Give extends Give_Unit_Test_Case {
	...
	public function test_includes() {
		...
		$this->assertFileExists( GIVE_PLUGIN_DIR . 'includes/database/class-give-donor.php' );
		$this->assertFileExists( GIVE_PLUGIN_DIR . 'includes/database/class-give-stats.php' );
		$this->assertFileExists( GIVE_PLUGIN_DIR . 'includes/database/class-give-session.php' );
