...
class CalculateProjectedAnnualRevenueTest extends TestCase
{
    ...
    public function subscriptionStartDateVariationsProvider(): array
    {
        ...
        $data = [
            ...
            'jan 1 quarterly every 1 quarter'  => ["{$currentYear}-01-01", SubscriptionPeriod::QUARTER(), 1, "{$currentYear}-08-31", 3, 1],
            ...
            'jan 1 quarterly every 2 quarters' => ["{$currentYear}-01-01", SubscriptionPeriod::QUARTER(), 2, "{$currentYear}-08-31", 2, 0],
            ...
            'jan 1 quarterly every 3 quarters' => ["{$currentYear}-01-01", SubscriptionPeriod::QUARTER(), 3, "{$currentYear}-08-31", 1, 1],
            ...
            'july 15 quarterly every 1 quarter'  => ["{$currentYear}-07-15", SubscriptionPeriod::QUARTER(), 1, "{$currentYear}-08-31", 1, 1],
            ...
            'july 15 quarterly every 2 quarters' => ["{$currentYear}-07-15", SubscriptionPeriod::QUARTER(), 2, "{$currentYear}-08-31", 1, 0],
            ...
            'july 15 quarterly every 3 quarters' => ["{$currentYear}-07-15", SubscriptionPeriod::QUARTER(), 3, "{$currentYear}-08-31", 1, 0],
            ...
            'dec 20 quarterly every 1 quarter'  => ["{$currentYear}-12-20", SubscriptionPeriod::QUARTER(), 1, "{$currentYear}-12-31", 1, 0],
            ...
            'dec 20 quarterly every 2 quarters' => ["{$currentYear}-12-20", SubscriptionPeriod::QUARTER(), 2, "{$currentYear}-12-31", 1, 0],
            ...
            'dec 20 quarterly every 3 quarters' => ["{$currentYear}-12-20", SubscriptionPeriod::QUARTER(), 3, "{$currentYear}-12-31", 1, 0],
