...
final class TestDonationRepository extends TestCase
{
    ...
    public function testUpsertMetaShouldNotDuplicateMeta(): void
    {
        ...
        $repository->upsertMeta($donation->id, 'test_key', 'Test Value One');
        $repository->upsertMeta($donation->id, 'test_key', 'Test Value Two');
    ...
    public function testUpsertMetaShouldInsertNewMeta(): void
    {
        $donation = Donation::factory()->create();
        $repository = new DonationRepository();
        $repository->upsertMeta($donation->id, 'test_key', 'test_value');
